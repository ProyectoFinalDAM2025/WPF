...
namespace app.View.Reportes.ReportesPerfiles
{
    public partial class ReportesPerfiles : Window
    {
        ...
        private void Ofertas_Click(object sender, RoutedEventArgs e)
        {
            app.View.Reportes.ReportesOfertas.ReportesOfertas ofertas = new app.View.Reportes.ReportesOfertas.ReportesOfertas();
            ofertas.Show();
            Close();
        }
